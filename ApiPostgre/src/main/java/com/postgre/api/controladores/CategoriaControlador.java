...
public class CategoriaControlador {
    ...
    @PutMapping("{id}")
    public ResponseEntity<CategoriaDto> alterarCategoria(@PathVariable("id") Long id,@RequestBody CategoriaDto categoriaDto){
    	CategoriaDto categoriaNova =  servicocategoria.alterarCategoria(id,categoriaDto);
    ...
    public ResponseEntity<String> deletarCategoria(@PathVariable("id") Long id){
    	servicocategoria.deletarCategoria(id);
